...
(set! %load-path
  (cons "/gnu/store/rva3m7b45la5ia7696yhjk768a96chld-guile-mingw-3.0.8-6.cc45597/share/guile/3.0" %load-path))
(set! %load-compiled-path
  (cons "/gnu/store/rva3m7b45la5ia7696yhjk768a96chld-guile-mingw-3.0.8-6.cc45597/lib/guile/3.0/site-ccache" %load-compiled-path))
